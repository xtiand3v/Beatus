        ...
        <div class="col-lg-4">
           <div class="card">
                <div class="card-header text-white">
                    <b>List</b>
                <span class="float:right"><a class="btn btn-primary btn-sm col-sm-3 float-right" style="width:100px; border-radius:5px; background-color:#c38888; color:white; border-color:#c38888; height:25px; font-size:15px;"  href="../index.php" id="">
        ...
        <div class="col-lg-8  p-field">
            ...
            <div class="card-footer">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-primary mr-2" style="width:100px; border-radius:5px; background-color:#c38888; color:white; border-color:#c38888; height:30px; font-size:15px;" type="button" type="button" id="pay">Pay</div>
                </div>
            </div>
            </div>      			
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      ...
      <div class="modal-body">
        <div class="container-fluid">
            ...
            <div class="form-group">
                <label for="">Vat(12%)</label>
                <input type="text" class="form-control text-right" id="vat" readonly value="12%">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control text-right" id="tendered" value="" required autocomplete="off">
            </div>
            <div class="form-group">
...
<script>
   ...
   $('#p-list .p-item').click(function(){
        ...
        tr.find('.btn-minus').click(function(e){
                e.preventDefault()
         ...
         tr.find('.btn-plus').click(function(e){
                e.preventDefault()
                var qty = $(this).siblings('input').val()
                    qty = parseInt(qty) + 1;
                    $(this).siblings('input').val(qty).trigger('change')
   ...
   $("#pay").click(function(){
    ...
    var newtotal = parseInt($('[name="total_amount"]').val()) + (parseInt($('[name="total_amount"]').val()) * 0.12)
    ...
    $('#total').val(parseFloat(newtotal).toLocaleString("en-US",{style:'decimal',minimumFractionDigits:2,maximumFractionDigits:2}))
   ...
   $('#tendered').keyup('input',function(e){
        ...
        tend = tend > 0 ? tend : 0;
        var amount= parseInt($('[name="total_amount"]').val()) + (parseInt($('[name="total_amount"]').val()) * 0.12)
