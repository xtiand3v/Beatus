        ...
        <div class="col-lg-4">
           <div class="card">
                <div class="card-header text-black">
                    <b>List</b>
                <span class="float:right"><a class="btn btn-primary btn-sm col-sm-3 float-right" style="width:80px; border-radius:5px; background-color:#c38888; color:white; border-color:#c38888; height:25px; font-size:15px;"  href="../index.php" id="">
        ...
        <div class="col-lg-8  p-field">
            ...
            <div class="card-footer">
                <div class="row justify-content-center">
                    <div class="btn btn btn-sm col-sm-3 btn-primary mr-2" style="width:80px; border-radius:5px; background-color:#c38888; color:white; border-color:#c38888; height:30px; font-size:15px;" type="button" id="pay">Pay</div>
                </div>
            </div>
            </div>      			
        </div>
