...
(function () {
	...
	PieceLabel.prototype.beforeDatasetsUpdate = function (chartInstance) {
		if (this.parseOptions(chartInstance) && this.position === 'outside') {
			...
			// console.log(this.fontSize,chartInstance.chartArea)
		// return false;
	...
	PieceLabel.prototype.drawDataset = function (dataset) {
		...
		// console.log(chartInstance._metasets)
		var meta = chartInstance._metasets[0];
	...
	PieceLabel.prototype.parseOptions = function (chartInstance) {
		var pieceLabel = chartInstance.config.options.pieceLabel;
		...
		if (pieceLabel) {
			...
			this.fontSize = pieceLabel.fontSize || 10;
			this.fontColor = pieceLabel.fontColor || '#000';
			this.fontStyle = pieceLabel.fontStyle || 'normal';
			this.fontFamily = pieceLabel.fontFamily || 'none';
			this.hasTooltip = chartInstance.tooltip && chartInstance.tooltip._active && chartInstance.tooltip._active.length;
